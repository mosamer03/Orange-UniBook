    ...
    if (AppUtils.isValidEmail(email)) {
      ...
      if (error != null) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('A password reset link has been sent to your email address.')),
        );
        Navigator.of(context).pop();
      }
    } else {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('اInvalid email address')));
    }
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const Icon(Icons.lock_outline, size: 80, color: AppColors.primaryBlack),
