...
class SettingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Setting', style: TextStyle(color: AppColors.primaryBlack, fontWeight: FontWeight.bold)),
        centerTitle: true,
        ...
        ListTile(
          ...
          trailing: Row(
            ...
            children: [
              ...
              if (showArrow) const Icon(Icons.arrow_forward_ios, size: 16, color: Colors.black54),
            ],
          ),
          onTap: onTap,
        ),
