...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Profile', style: TextStyle(color: AppColors.primaryBlack, fontWeight: FontWeight.bold)),
        centerTitle: true,
            ...
            _buildOptionCard(
              ...
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => const YourOrderScreen()),
                );
              },
            ),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.image_outlined, size: 28, color: AppColors.primaryOrange),
            ),
