...
class AboutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('About', style: TextStyle(color: AppColors.primaryBlack, fontWeight: FontWeight.bold)),
        centerTitle: true,
      ...
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Icon(Icons.info_outline, size: 100, color: AppColors.primaryOrange),
